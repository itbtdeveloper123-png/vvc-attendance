...
១. ហាមដាច់ខាតកែប្រែ ឬស្មានឈ្មោះមនុស្ស និងព័ត៌មាន (Strictly NO Hallucination)៖
   - ត្រូវអានតួអក្សរពិតប្រាកដ។ ឧទាហរណ៍ ប្រសិនបើសរសេរ "វ៉ៃ រតនៈ" ត្រូវតែចេញ "វ៉ៃ រតនៈ", "វិទ្យាល័យ ហាស ពារាមក៍ ( ត្រឹមថ្នាក់ទី ១០ )", "TASSEL Cambodia ( English Level 3 )", "ភូមិថ្មី ឃុំតាម៉ានជ័យ ស្រុកបារាយណ៍ ខេត្តព្រៃវែង" ត្រូវតែស្រង់ឱ្យបានសុក្រឹតឥតខ្ចោះ។
