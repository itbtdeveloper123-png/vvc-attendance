...
class BackendTheme {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'background_color': '#${backgroundColor.toARGB32().toRadixString(16).substring(2)}',
      'card_color': '#${cardColor.toARGB32().toRadixString(16).substring(2)}',
      'text_primary_color': '#${textPrimaryColor.toARGB32().toRadixString(16).substring(2)}',
      'text_secondary_color': '#${textSecondaryColor.toARGB32().toRadixString(16).substring(2)}',
