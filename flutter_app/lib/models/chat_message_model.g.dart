...
const ChatMessageSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'voiceDuration': PropertySchema(
      id: 12,
      name: r'voiceDuration',
      type: IsarType.long,
    )
  },
...
void _chatMessageSerialize(
  ...
  writer.writeString(offsets[7], object.senderAvatar);
  ...
  writer.writeLong(offsets[12], object.voiceDuration);
}
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    ...
    isSent: reader.readBoolOrNull(offsets[4]) ?? true,
    messageId: reader.readString(offsets[5]),
    roomId: reader.readString(offsets[6]),
    senderAvatar: reader.readStringOrNull(offsets[7]),
    senderId: reader.readString(offsets[8]),
    senderName: reader.readStringOrNull(offsets[9]),
    timestamp: reader.readLong(offsets[10]),
    type: _ChatMessagetypeValueEnumMap[reader.readStringOrNull(offsets[11])] ??
        MessageType.text,
    voiceDuration: reader.readLongOrNull(offsets[12]),
  );
  object.id = id;
  return object;
}
...
extension ChatMessageByIndex on IsarCollection<ChatMessage> {
  Future<ChatMessage?> getByMessageId(String messageId) {
    return getByIndex(r'messageId', [messageId]);
  }

  ChatMessage? getByMessageIdSync(String messageId) {
  ...
  Future<List<ChatMessage?>> getAllByMessageId(List<String> messageIdValues) {
    final values = messageIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'messageId', values);
  }

  List<ChatMessage?> getAllByMessageIdSync(List<String> messageIdValues) {
    final values = messageIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByMessageId(ChatMessage object) {
    return putByIndex(r'messageId', object);
  }

  Id putByMessageIdSync(ChatMessage object, {bool saveLinks = true}) {
    return putByIndexSync(r'messageId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByMessageId(List<ChatMessage> objects) {
    return putAllByIndex(r'messageId', objects);
  }

  List<Id> putAllByMessageIdSync(List<ChatMessage> objects,
      {bool saveLinks = true}) {
...
extension ChatMessageQueryWhere
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> messageIdEqualTo(
      String messageId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> messageIdNotEqualTo(
      String messageId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> fileSizeEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'fileSize',
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> fileSizeBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> isSentEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isSent',
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'voiceDuration',
      ));
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      voiceDurationIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'voiceDuration',
      ));
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      voiceDurationEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'voiceDuration',
        value: value,
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByFileSize() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fileSize', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByFileSizeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsSent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSent', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsSentDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortBySenderAvatar() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByVoiceDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voiceDuration', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortByVoiceDurationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voiceDuration', Sort.desc);
    });
  }
}
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByFileSize() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fileSize', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByFileSizeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fileSize', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsSent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSent', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsSentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSent', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenBySenderAvatar() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderAvatar', Sort.asc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByVoiceDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voiceDuration', Sort.asc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByFileSize() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByIsSent() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctBySenderAvatar(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByVoiceDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'voiceDuration');
    });
  }
}
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, int?, QQueryOperations> fileSizeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, bool, QQueryOperations> isSentProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations> senderAvatarProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, int, QQueryOperations> timestampProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, int?, QQueryOperations> voiceDurationProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'voiceDuration');
    });
  }
}
