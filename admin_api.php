            ...
            if ($localAudioFile !== '' && $geminiKey !== '' && file_exists($localAudioFile)) {
                ...
                if ($uploadedAudioUri !== '') {
                    $audioPrompt = "អ្នកជាជំនួយការ AI សម្រាប់កត់ត្រាកំណត់ហេតុកិច្ចប្រជុំ និងសង្ខេបកិច្ចប្រជុំពីសំឡេងផ្ទាល់ជាភាសាខ្មែរ (Executive Minutes of Meeting & Full Transcript from Audio)។\n\n"
                        ...
                        . "===SUMMARY_END===\n\n"
                        . "===TRANSCRIPT_START===\n"
                        . "អត្ថបទសន្ទនាទាំងស្រុង (Full Transcript & Dialogue) តាមលំដាប់លំដោយនៃអ្នកនិយាយ ព្រមទាំងដាក់ Timestamp ពេលវេលា [MM:SS] នៅដើមបន្ទាត់នៃអ្នកនិយាយនីមួយៗ (ឧទាហរណ៍៖ [00:05] **អ្នកគ្រប់គ្រង (វិច)៖** ...)\n"
                        . "===TRANSCRIPT_END===\n\n"
