...
// ===============================================
define('AI_CHAT_PROVIDER', getenv('AI_CHAT_PROVIDER') ?: 'gemini');
define('AI_CHAT_MODEL', getenv('AI_CHAT_MODEL') ?: 'gemini-2.5-flash');
...
define('MEETING_AI_WORKER_URL', $rawWorkerUrl);
